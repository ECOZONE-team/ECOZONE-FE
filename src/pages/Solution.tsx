...
import icon1 from "../assets/main/application1.png";
import icon2 from "../assets/main/application2.png";
import icon3 from "../assets/main/application3.png";
        ...
        <Row>
          ...
          <Content>
            ...
            <Text>
              ...
              구조
              <br />
              업체관리자와 현장담당자의 권한 구분으로 데이터 입력 오류 방지
            </Text>
          </Content>
        </Row>
        <Row>
